...
**Course:** Computer Networks — Odd Semester 2025, Bina Nusantara University
...
- **IP Planning & Cost Calculation:** Microsoft Excel
...
├── docs/
│   ├── Proposal_Kelompok_8_AOL_Computer_Networks.pdf   ← Full project report: background, objectives, and detailed
│   │                                                       explanation of all 5 network layers
│   └── PPT_AOL_Kelompok_8.pdf                          ← Presentation slides summarizing the design and results
├── data/
│   └── EXCEL_AOL_Kelompok8.xlsx                        ← All supporting calculations, across sheets:
...
│                                                           - Tabel Alokasi IP Address Router
│                                                           - Routing Table (static routing configuration)
│                                                           - Application Layer (service & port mapping)
│                                                           - Testing (PING & connectivity test results)
├── simulation/
│   └── Cisco-Packet-Tracer_AOL_Kelompok8.pkt           ← Full network simulation, all 3 floors in one file,
│                                                           with inter-floor and intra-floor device connectivity
└── README.md
```
